...
Object.assign(paperData, {
    ...
    'econ_2024_fm_42': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_m24_qp_42.pdf", 
        questions: [
    ...
    'econ_2024_mj_41': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_s24_qp_41.pdf",
        questions: [
    ...
    'econ_2024_mj_42': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_s24_qp_42.pdf",
        questions: [
    ...
    'econ_2024_mj_43': { 
        title: "Income inequality", 
        pdf: "assets/pdfs/economics/paper4/9708_s24_qp_43.pdf",
        questions: [
            { n:'4', m:20, t:"'The achievement of economic growth requires a reallocation of resources. It is wrong, therefore, for a government to spend more to increase economic growth as it is good for its country.' To what extent do you agree with this argument?", l:'400-600'},
            { n:'5', m:20, t:"National income statistics are often used as a measure of the standard of living. Consider to what extent national income statistics can be used to compare the standard of living between low-income countries and high-income countries.", l:'400-600'}
        ] 
    ...
    'econ_2024_on_42': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_w24_qp_42.pdf",
        questions: [
    ...
    'econ_2025_fm_42': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_m25_qp_42.pdf", 
        questions: [
    ...
    'econ_2025_mj_41': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_s25_qp_41.pdf",
        questions: [
    ...
    'econ_2025_mj_42': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_s25_qp_42.pdf",
        questions: [
    ...
    'econ_2025_mj_43': { 
        title: "The influence of governments", 
        pdf: "assets/pdfs/economics/paper4/9708_s25_qp_43.pdf",
        questions: [
            { n:'4', m:20, t:"A country is experiencing stagflation, when there is a high rate of inflation at the same time as a negative output gap. With the help of a diagram, evaluate the effectiveness of using fiscal policy to solve this problem.", l:'400-600'},
            { n:'5', m:20, t:"A free trade area gains all the benefits associated with being a member of a customs union while avoiding all the costs associated with being a member of a customs union. Evaluate this statement.", l:'400-600'}
        ] 
    ...
    'econ_2025_mj_44': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_s25_qp_44.pdf",
        questions: [
    ...
    'econ_2025_on_41': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_w25_qp_41.pdf",
        questions: [
    ...
    'econ_2025_on_42': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_w25_qp_42.pdf",
        questions: [
    ...
    'econ_2025_on_43': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_w25_qp_43.pdf",
        questions: [
    ...
    'econ_2025_on_44': { 
        ...
        pdf: "assets/pdfs/economics/paper4/9708_w25_qp_44.pdf",
        questions: [
