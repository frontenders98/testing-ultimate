...
const econP3Data = {
    "2025_fm_32": [
        { 
            "q": "Which cost will continually decrease as a firm's output increases in the short run?", 
            "options": { 
                "A": "average cost", 
        ...
        { 
            "q": "What is an example of market failure?", 
            "options": { 
        ...
        { 
            "q": "What is likely to prevent the development of an effective cartel in an industry?", 
            "options": { 
        ...
        { 
            "q": "The diagram shows a firm's cost and revenue curves. The firm changes its objective from profit maximising to revenue maximisation. Which area on the diagram will show the increase in total revenue? [Refer to PDF Diagram]", 
            "options": { 
                "A": "Z", 
                "B": "Y + Z", 
                "C": "X + Y", 
        ...
        { 
            "q": "Which statement about the downward sloping demand curve of an inferior good is correct?", 
            "options": { 
        ...
        // You can continue adding questions 6 to 30 following this exact format!
    ]
};
...
function startMCQTest(paperID) {
    ...
    // Inject the questions and options safely
...
function gradeMCQ() {
    ...
    // Safely build the Results Screen
